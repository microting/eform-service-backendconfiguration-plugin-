...
if (( "$GIT_STATUS" > 0 )); then
  ...
  CURRENT_NUMBER_OF_COMMITS=`git log --oneline | wc -l`
	...
	PACKAGES=('Microting.eForm' 'Microting.eFormApi.BasePn' 'Microting.EformBackendConfigurationBase' 'Magick.NET-Q16-x64' 'Microting.ItemsPlanningBase' 'SendGrid' 'ChemicalsBase' 'Microting.EformAngularFrontendBase')
